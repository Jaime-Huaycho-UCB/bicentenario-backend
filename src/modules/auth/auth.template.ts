...
export const htmlTwoFactorVerification = (codigo) => {
  return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
    ...
    <div class="container">
        ...
        <p class="message">Para continuar con tu inicio de sesión, por favor ingresa el siguiente código de verificación que hemos enviado a tu correo electrónico:</p>
        ...
        <div class="footer">
            <p>¿No recibiste el código? reinicia el proceso</p>
        </div>
    </div>
